...
<div class="overlappingItemContainer exp-text topThing">
    ...
    <div id="overlays" class="overlappingItemContainer">
        <div class="exp-slide-2">
            <div class="frostedbg">
                What causes that see-through effect?
            </div>
        </div>
    </div>
</div>
...
<div class="overlappingItemContainer bottomThing">
    <div class="exp-slide">
                Let's start by examining the structure of just andalusite for now.
    </div>
    <div class="exp-slide">
    ...
    <div class="exp-slide">
                Here's a more precise way to think about this "line effect": if we took the entire crystal and moved it in the direction we're looking, every moved atom would line up with a different atom in the original crystal.
    </div>
    <div class="exp-slide">
