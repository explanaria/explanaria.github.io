...
export const canvasSize = 70;


export const triangleRadius = 0.35*canvasSize;
export const arrowCenterDistance = 0.43*canvasSize; //how far from the center should the arced arrow that shows a rotation be?
