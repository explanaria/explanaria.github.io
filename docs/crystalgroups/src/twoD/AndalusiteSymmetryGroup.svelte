<script>
    ...
    import { defaultGroupElementBorderColor, generatorColors, identityColor, specialGeneratorColors} from "../colors.js";
...
<div class="groupdisplay">
    ...
    <SVGCayleyArrows group={group} positionsPerElementMap={positions} isArrowVisibleMap={isArrowVisibleMap} specialGeneratorColors={specialGeneratorColors} elementAvoidRadius={1.25}/>
</div>
